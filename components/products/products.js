                                            ...
                                            <div className="col-md-6">
                                                <section className="product-description">
                                                    ...
                                                    <div className="contact-info">
                                                        <h4>Interested?</h4>
                                                        <p><strong>Phone:</strong> <a>{product.phone}</a></p>
                                                        <p><strong>E-mail:</strong> <a>{product.email}</a></p>
                                                    </div>
                                                </section>
                                            </div>
                                        </div>
